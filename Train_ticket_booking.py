...
class Ticket:
    def __init__(self, train, source, destinattion, passengers, pnr):
        self.train = train 
        self.source = source
        self.destination = destinattion
...
if logged_in_account is not None:
    trains = [
        Train("17234", "Bellampalli", "Secunderabad", 50),
        Train("12626", "Ramagundam", "Tirupati", 34),
        Train("16032", "Ramagundam", "Chennai Central", 38),
        Train("20806", "Ramagundam", "Visakhapatnam", 25),
